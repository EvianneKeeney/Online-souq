...
while command == 0
  ...
  if answer == "y"
    ...
    puts "Here is a list of your items!"
    ...
    puts "Also, we noticed that some of your requested items were out of stock."
    puts "Here is a list of those items."
    puts "We will notify you when they are added to our inventory:"
    puts ""

    misc_cart.each do |item|
      print "*"
      puts item
    end
